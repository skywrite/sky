...
---
Meeting notes here.`),
    path: '/test/time/2026/W06/02-03/actions/meetings/kickoff.md',
  },
  {
    doc: doc(`---
who: Charlie
...
---
Phone call notes.`),
    path: '/test/time/2026/W06/02-03/actions/meetings/sync.md',
  },
]
...
---
Recent message.`),
    path: '/test/time/2026/W06/02-03/actions/messages/status.md',
  },
  {
    doc: doc(`---
from: Tanisha
...
---
Another message.`),
    path: '/test/time/2026/W06/02-03/actions/messages/intro.md',
  },
]
...
---
Talk notes.`),
    path: '/test/time/2026/W06/02-03/actions/videos/talk.md',
  },
  {
    doc: doc(`---
from: CookingShow
...
---
Recipe notes.`),
    path: '/test/time/2026/W06/02-03/actions/videos/recipe.md',
  },
]
...
Evening review of the day.`),
    path: '/test/time/2026/W06/02-04/journal/evening.md',
  },
]
...
# Brainstorm Marketing Ideas`),
    path: '/test/time/2026/W06/02-04/actions/ai-chats/18-42_Brainstorm-Marketing-Ideas.md',
  },
]
...
---
Day file.`),
    path: '/test/time/2026/W06/02-03/day.md',
  },
  {
    doc: doc(`---
date: "2026-02-04"
...
---
Day file.`),
    path: '/test/time/2026/W06/02-04/day.md',
  },
]
