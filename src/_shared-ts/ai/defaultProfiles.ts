...
export const PROFILES = {
  ...
  // what resolveProfile's thinkingEnabled() reads to strip sampling params, and this
  // model 400s on temperature/topP/topK. Stating it keeps that guard armed. The API's
  // own default effort is medium; xhigh keeps the depth the reasoning role ran at.
  'default-opus-5.5': defineProfile({
    provider: 'anthropic',
  ...
  // step deliberating (measured 2026-09-06 on Opus 5) and medium keeps the judgment.
  'default-opus-5.5-medium': defineProfile({
    provider: 'anthropic',
    model: 'claude-opus-5-5',
    contextWindow: 1_000_000,
