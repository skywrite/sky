...
test('recencyTypeScorer — priority path gets +10 boost', () => {
  const priorityPaths = new Set(['/Notebook/time/2026/02/23-01/23/actions/videos/Video_James.md'])
