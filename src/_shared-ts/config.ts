...
export const DIR_TRACKING_ASSETS = path.join(DIR_TRACKING, 'assets')
export const DIR_TRACKING_LOCATION = path.join(DIR_TRACKING, 'location')
export const DIR_TRACKING_WEATHER = path.join(DIR_TRACKING, 'weather')

export const DIR_DECISIONS = path.join(DIR_BASE, 'decisions')
export const DIR_GOALS = path.join(DIR_BASE, 'goals')
export const DIR_HEARTBEAT = path.join(DIR_BASE, 'heartbeat')
export const DIR_HEARTBEAT_FOLLOW = path.join(DIR_HEARTBEAT, 'follow')
