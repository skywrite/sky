...
const params = {
  throw: Flag.bool('Throw an error instead of returning CommandResult'),
  error: Flag.bool('Return CommandResult.error()', { short: 'e' }),
  fail: Flag.bool('Return CommandResult.fail()', { short: 'f' }),
}
