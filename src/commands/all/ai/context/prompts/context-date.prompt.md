...
- "What did I discuss last week?" → { since: "14d", until: "", dates: [] }
- "Look back 5 years" → { since: "5y", until: "", dates: [] }
- "Look at all docs since March 1 of 2025" (asked 2026-08-15, a ~17.5mo gap) → { since: "18mo", until: "", dates: ["2025-03-01"] }
- "Meetings from mid-March through June 1" (asked 2026-08-15) → { since: "6mo", until: "2026-06-01", dates: ["2026-03-15", "2026-06-01"] }
- "What happened in March 2026?" (asked 2026-08-15) → { since: "6mo", until: "2026-03-31", dates: ["2026-03-01", "2026-03-31"] }
- "Check Feb 18 and Feb 24 threads" → { since: "30d", until: "", dates: ["2026-02-18", "2026-02-24"] }
- "Tell me about James" → { since: "", until: "", dates: [] }
- "What's our biggest growth opportunity over the next 3 months?" → { since: "", until: "", dates: [] }
- "Given the last 6 months, what should I plan for next quarter?" → { since: "6mo", until: "", dates: [] }
