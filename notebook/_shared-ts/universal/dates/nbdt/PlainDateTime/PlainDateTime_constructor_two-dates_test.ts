...
const FIXTURES = [
  {
    input: [new Date(2024, 1, 10, 13, 45), new Date(2024, 1, 10, 13, 45)],
    expected: `2024-02-10 13:45`,
  },
  {
    input: [new Date(2024, 1, 10, 1, 45), new Date(2024, 1, 9, 1, 45)],
    expected: `2024-02-09 25:45`,
  },
  {
    input: [new Date(2024, 1, 10, 7, 45), new Date(2024, 1, 9, 1, 45)],
    expected: `2024-02-09 31:45`,
  },
  {
    input: [new Date(2024, 1, 10, 7, 45), new Date(2024, 1, 9, 1, 45)],
    expected: `2024-02-09 31:45`,
