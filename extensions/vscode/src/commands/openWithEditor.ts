...
const APP_PATH = '/Applications/Editor.app'
const BIN = 'open' // we use open to bring Editor to the topmost / foreground

export default async function openWithEditor(uri?: vscode.Uri): Promise<void> {
