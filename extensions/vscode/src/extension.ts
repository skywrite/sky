...
import openWithTypora from './commands/openWithTypora.ts'
...
import LibraryCompletionProvider from './completions/LibraryCompletionItemProvider.ts'
...
export function activate(context: vscode.ExtensionContext) {
  ...
  const disposable5 = vscode.commands.registerCommand('extension.opentypora', openWithTypora)
