...
service is launchd-based and macOS-only, as are a few commands (device location, Typora
integration).
...
This is interactive. It asks four questions and defaults are fine for all of them:
